    ...
    <aside className={`${THEME.sidebarBg} sticky top-14 hidden h-[calc(100vh-3.5rem)] w-[360px] overflow-y-auto border-l ${THEME.borderColor} px-2 py-3 lg:block backdrop-blur-md backdrop-saturate-150 ${THEME.glow}`}>
      ...
      <div className="fixed bottom-0 right-4 z-10 flex space-x-2">
        {activeChats.map((chat) => (
          ...
          >
            {/* Chat header */}
            <div className={`flex h-12 items-center justify-between border-b ${THEME.borderColor} bg-gradient-to-r from-gray-900/90 to-gray-800/90 px-3 py-2`}>
              ...
              <div className="flex items-center gap-1">
                ...
                <button className={`rounded-full p-1 ${THEME.textSecondary} transition-all duration-200 ${THEME.buttonHover} hover:text-rose-500 hover:scale-110`}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-5">
            ...
            {!chat.minimized && (
              <>
                <div className="flex-1 overflow-y-auto p-3 bg-gradient-to-b from-gray-900 to-gray-950">
                ...
                <div className="flex items-center border-t border-gray-800/40 bg-gray-900/80 p-2 backdrop-blur-sm">
                  ...
                  <input
                    type="text"
                    placeholder="Aa"
                    className={`mx-2 flex-1 rounded-full ${THEME.inputBg} px-3 py-1.5 ${THEME.textPrimary} outline-none focus:ring-1 focus:ring-indigo-500/50 transition-all duration-200`}
                  />
                  <button className="rounded-full p-1.5 text-indigo-500 transition-all duration-200 hover:bg-indigo-500/20 hover:text-indigo-400 hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-5">
        ...
        <div className="mt-3 space-y-1.5 px-1">
          {contacts.map((contact) => (
            <div key={contact.id} className="group">
              <div className={`flex w-full items-center gap-3 rounded-lg px-3 py-2 transition-all duration-200 hover:bg-gray-800/40 hover:translate-x-1 cursor-pointer`}>
                ...
                <div className="opacity-0 transition-opacity group-hover:opacity-100">
                  <div className="flex space-x-1">
                    <div className="rounded-full p-1 text-gray-400 transition-colors hover:bg-gray-800/60 hover:text-indigo-400 cursor-pointer">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-5">
                        <path fillRule="evenodd" d="M1.5 4.5a3 3 0 013-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 01-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 006.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 011.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 01-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5z" clipRule="evenodd" />
                      </svg>
                    </div>
